...
BENCHMARKS = [
    ...
    Benchmark("file_pread_pwrite_64k", None, 32 * 1024 * 1024, "self", "/tmp/bench-hot-paths/bin/file_pread_pwrite_64k"),
    Benchmark("file_pread_pwrite_4k", None, 32 * 1024 * 1024, "self", "/tmp/bench-hot-paths/bin/file_pread_pwrite_4k"),
    Benchmark("file_pread_pwrite_random_64k", None, 80 * 1024 * 1024, "self", "/tmp/bench-hot-paths/bin/file_pread_pwrite_random_64k"),
    Benchmark("fstat_loop", None, None, "self", "/tmp/bench-hot-paths/bin/fstat_loop"),
    Benchmark("stat_misses", None, None, "self", "/tmp/bench-hot-paths/bin/stat_misses"),
    Benchmark("stat_cache_large_misses", None, None, "self", "/tmp/bench-hot-paths/bin/stat_cache_large_misses"),
    Benchmark("stat_cache_write_txn", None, None, "self", "/tmp/bench-hot-paths/bin/stat_cache_write_txn"),
    Benchmark("socket_msg_iov", None, 128 * 1024 * 1024, "self", "/tmp/bench-hot-paths/bin/socket_msg_iov"),
    Benchmark("syscall_identity", None, None, "self", "/tmp/bench-hot-paths/bin/syscall_identity"),
    Benchmark("time_syscalls", None, None, "self", "/tmp/bench-hot-paths/bin/time_syscalls"),
    Benchmark("futex_eagain", None, None, "self", "/tmp/bench-hot-paths/bin/futex_eagain"),
    Benchmark("eventfd_loop", None, None, "self", "/tmp/bench-hot-paths/bin/eventfd_loop"),
    Benchmark("epoll_eventfd", None, None, "self", "/tmp/bench-hot-paths/bin/epoll_eventfd"),
    Benchmark("poll_many_ready", None, None, "self", "/tmp/bench-hot-paths/bin/poll_many_ready"),
    Benchmark("mmap_faults", None, 256 * 1024 * 1024, "self", "/tmp/bench-hot-paths/bin/mmap_faults"),
    Benchmark("fd_control", None, None, "self", "/tmp/bench-hot-paths/bin/fd_control"),
    Benchmark("fd_high_churn", None, None, "self", "/tmp/bench-hot-paths/bin/fd_high_churn"),
    Benchmark("process_wait", None, None, "self", "/tmp/bench-hot-paths/bin/process_wait"),
    Benchmark("signal_mask", None, None, "self", "/tmp/bench-hot-paths/bin/signal_mask"),
    Benchmark("identity_extended", None, None, "self", "/tmp/bench-hot-paths/bin/identity_extended"),
    Benchmark("yield_loop", None, None, "self", "/tmp/bench-hot-paths/bin/yield_loop"),
